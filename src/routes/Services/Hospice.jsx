...
function Hospice() {
  ...
  const supportImages = [galleryImages[0], galleryImages[4]].filter(Boolean);
  ...
  return (
    <div className="page service-page">
      ...
      >
        <h1>Hospice Care</h1>
        <p className="lead">
          Comfort-focused care for patients with serious, life-limiting illness - and compassionate support for the
      ...
      <section className="section">
        ...
        <p>
          Hospice at Roadrunner Healthcare focuses on comfort, dignity, and quality of life for patients facing serious
          illness. Our goal is not to cure the disease, but to manage symptoms, ease suffering, and support both
          patients and families through every step of the journey.
        </p>
        <p>Hospice is not about giving up - it's about living as fully and comfortably as possible at home.</p>
      ...
      <section className="section highlight">
        ...
        <p>Every hospice patient is supported by an interdisciplinary team including:</p>
      ...
      <section className="section">
        ...
        <p>Hospice may be appropriate when a patient has a serious illness and:</p>
        ...
        <p>
          <strong>Important:</strong> Patients do not have to be "actively dying" to receive hospice care. Earlier
          referrals allow our team to provide better symptom control and more support for families.
        </p>
      </section>

      <section className="section">
        <h2>Insurance & eligibility</h2>
        <p>Hospice is a Medicare benefit covered 100% by Medicare, Medicaid, and most private insurances. Patients are eligible when:</p>
        <ul>
        ...
        <p>There is no cost to patients or families for hospice services, medications, equipment, or supplies related to the hospice diagnosis.</p>
      </section>

      <section className="section">
        <h2>How to get started</h2>
        <p>Anyone can refer a patient to hospice - families, physicians, hospitals, or facilities. Here's what happens next:</p>
        <ol className="process-list">
          <li>
            <strong>Initial contact</strong> - Call us or submit a referral. We'll discuss the patient's situation and determine if hospice is appropriate.
          </li>
          <li>
            <strong>Physician coordination</strong> - We coordinate with the patient's doctor to review eligibility and obtain certification.
          </li>
          <li>
            <strong>Admission</strong> - A nurse meets with the patient and family to explain hospice, complete paperwork, and create a personalized care plan.
          </li>
          <li>
            <strong>Care begins</strong> - Your hospice team starts visits, delivers equipment, and provides 24/7 on-call support.
          </li>
        </ol>
      </section>
      ...
      <section className="section cta-section">
        ...
        <p>Our team is available 24/7 to talk through your situation and answer questions.</p>
